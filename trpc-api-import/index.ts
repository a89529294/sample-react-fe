...
const TRPC_API_DIST = {
  owner: "a89529294",
  repository: "sample-hono-be",
  filePaths: [
    {
      sourcePath: "trpc-api-export/build/index.d.ts",
      targetPath: "src/common/trpc-api/api-types/index.d.ts",
    },
    {
      sourcePath: "trpc-api-export/build/index.js",
      targetPath: "src/common/trpc-api/api-types/index.js",
    },
  ],
